    ...
    public void setData()
    {
        ...
        for(int j=0;j<out.getDayPlan().size();j++)
        {
           ...
           for(int a=0;a<out.getDayPlan().get(j).getVisitingPlpaces().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getVisitingPlpaces().get(a).getApproximateTime());
           ...
           for(int a=0;a<out.getDayPlan().get(j).getMorningMeal().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getMorningMeal().get(a).getApproximateTime());
           ...
           for(int a=0;a<out.getDayPlan().get(j).getLunch().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getLunch().get(a).getApproximateTime());
           ...
           for(int a=0;a<out.getDayPlan().get(j).getEvening().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getEvening().get(a).getApproximateTime());
           ...
           for(int a=0;a<out.getDayPlan().get(j).getDinner().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getDinner().get(a).getApproximateTime());
           ...
           for(int a=0;a<out.getDayPlan().get(j).getRestaurant().size();a++)
           {
               ...
               String temp3=Double.toString(out.getDayPlan().get(j).getRestaurant().get(a).getApproximateTime());
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(route, javax.swing.GroupLayout.DEFAULT_SIZE, 622, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(316, 316, 316)
